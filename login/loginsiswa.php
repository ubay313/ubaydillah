<html>
    <head>
        ...
        <style>
            body,html{background-position:right;}
            body{background-image:url('../img/urban2.jpg'); background-size:cover; min-height:95%;}
            @font-face{font-family:"judul"; src:url('../font/NantonBold.otf');}
            @font-face{font-family:"judul2"; src:url('../font/OCR.ttf');}
            span#judul{font-family:"judul"; color:#fff; text-shadow:2px 2px 2px black; font-size:40pt;}
    ...
    <center><span id="judul">Login Siswa</span></center>
    <?php for($a=0; $a<5; $a++) echo "<br>"; ?>
    
        <div class="tengah">
            <br>
                <form action="proseslogin-siswa.php" method="post">
